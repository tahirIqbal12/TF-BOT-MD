 ...
 * @author : HACKER TF F<https://github.com/tahiriqbal12>
...
const ownerNumber = ['923321709972']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("TF-BOT-MD~", '');
...
console.log("CONNECTING TF-BOT-MD 🧬...");
...
console.log('TF-BOT-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ TF-BOT-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ HACKER TF ✅*
...
//================ownerreact==============
if(senderNumber.includes("923321709972")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("923321709972")){
...
app.get("/", (req, res) => {
res.send("HEY, TF-BOT-MD STARTED ✅");
});
